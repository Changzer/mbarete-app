...
export function LegalPage({
  ...
  return (
    <div className="flex min-h-screen flex-col light-paper bg-surface-2">
      <div className="mx-auto w-full max-w-2xl flex-1 px-4 py-10">
        ...
        <div className="legal-prose mt-6 flex flex-col gap-4 text-base leading-relaxed text-ink">
          {children}
        </div>
      </div>
      <BeianFooter />
