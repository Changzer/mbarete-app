...
/**
 * Defaults to cents; supplier unit costs can request four places so VAT
 * on low-value items stays visible before quantity multiplication.
 *
 ...
 */
export function formatMoney(value: number, currency: string, maximumFractionDigits = 2) {
